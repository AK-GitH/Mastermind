//IRRELEVANT TO RUNNING FILE SINC mm-matches.s WAS LEFT COMPLETE DUE TO INLINE ASSEMBLY IMPLEMENTATION IN MAIN master-mind FILE IN FUNCTION coutnMatches
/*
